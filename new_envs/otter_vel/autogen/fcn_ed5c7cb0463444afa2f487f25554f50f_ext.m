function [u, log] = fcn_ed5c7cb0463444afa2f487f25554f50f_ext(y_ref, y, dt, u_ic, params, data, pid__, iid__)
...
function log = eval_log(data)
        log.x_op_u = data.x_op_u;
    log.x_op_y = data.x_op_y;
    log.x_op_g = data.x_op_g;
